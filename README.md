Spring MVC and Ajax Showcase with HDIV
--------------------------------------
Spring MVC sample application that uses Ajax for navigation and form submission.
HDIV is added to secure the application.
One tab is added to the application, "Partial Forms", that contains partial form update example with Ajax.
